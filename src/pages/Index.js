...
const Index = () => (
  ...
  >
    <article className="post" id="index">
      ...
      <p>I was recently and briefly a <b>Java Developer</b> with sportsbook/iGambling company
        <a href="https://fsbtech.com/"> FSB Tech</a> having joined the team at the start of
        November 2022.
      </p>
      <p>Unfortunately in December 2022 FSB was forced to close its Glasgow office
        as a result of chaotic role restructuring and unsustainable market strategies.
        Subsequently, I am now looking for a new developer position and keen to join a
      ...
      <p>Please don&apos;t hesitate to get in touch if my skill-set and experience aligns with the
        business goals of your organisation.
      </p>
    </article>
  </Main>
);
